...
const uint64_t MONEY_SUPPLY                                  = const uint64_t MONEY_SUPPLY = (uint64_t)(-1);
...
const char     CRYPTONOTE_NAME[]                             = "SofiaCoin";
...
const int P2P_DEFAULT_PORT = 19456;  
//TODO This port will be used by the daemon to interact with simlewallet
const int RPC_DEFAULT_PORT = 19457;
